...
> 学完本讲你能：用时间轴攻克 have done / had done；会判断「影响延续至今」与「过去的过去」，修复 G1 / G2 类错误（G1 / G2 = [水平自测](../../../00-水平自测.md) 中的两道时态题：G1 考 for + 时间段的现在完成，G2 考「过去的过去」要用 had done）。
...
- 题目：[L04 练习](practice.md)（基础层必做，强化层选做，答案在文末）
- 错题记录：
...
🔗 下一讲：[L05 将来表达法与主将从现](../L05-将来表达法与主将从现/lesson.md)
