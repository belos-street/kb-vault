...
program.name('my-cli').description('A sample CLI tool').version('1.0.0')
...
program
  ...
  .action(() => {
    ...
    console.log(chalk.gray('─'.repeat(40)))
    console.log(
      chalk.cyan('init') + chalk.gray('     ') + 'Initialize a new project'
    )
    console.log(
      chalk.cyan('help-text') + chalk.gray('  ') + 'Show this help message'
    )
    console.log()
  })
