根据"快速上手、面试能答、做出游戏"的目标，这份大纲把 PixiJS 学习拆解成 **9 个模块**（6 基础 + 2 进阶 + 1 实战），每天 1~2 小时，**约两周完成**。模块 1-6 对应面试核心知识点，模块 7-8 是进阶技巧，模块 9 用**飞机大战**实战项目串联全部知识。
...
### 模块 9：飞机大战（5~7 天）
**面试可答**：完整的 2D 游戏开发流程，场景管理、对象池、碰撞检测的综合运用。
...
| 第 6-7 天 | 模块 7 | 碰撞检测、对象池 |
| 第 8-9 天 | 模块 8 | 遮罩、滤镜、性能优化 |
| 第 10-14 天 | 模块 9：飞机大战 | 碰撞、对象池、粒子特效、项目完善 |
