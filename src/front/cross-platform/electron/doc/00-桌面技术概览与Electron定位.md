...
| 41.x | 146 | 24.14 | 2026-03 | ✅ 受支持（2026-08-25 EOL） |
| 42.x | 148 | 24.15 | 2026-05 | ✅ 受支持 |
| 43.x | 150 | 24.17 | 2026-06 | ✅ 当前稳定版 |

> 版本策略：Electron 与 Chrome 同步，约每 8 周发布一个新主版本，**同时只支持最近三个主版本**（当前为 41/42/43）。选择 Electron 版本时，关注其捆绑的 Chromium 版本——这决定了你能用哪些 Web API（如 CSS 特性、Web API 等）。版本与 EOL 时间可查官方发布日历：releases.electronjs.org。
