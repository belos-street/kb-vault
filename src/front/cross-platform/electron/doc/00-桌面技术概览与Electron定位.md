...
| Electron 版本 | Chromium 版本 | Node.js 版本 | 发布时间 | 备注 |
|---------------|--------------|-------------|---------|------|
| 35.x | 134 | 22.14 | 2025-03 | 已停止支持 |
| 36.x | 136 | 22.14 | 2025-04 | 已停止支持 |
| 37.x | 138 | 22.16 | 2025 Q2 | 已停止支持 |
| 38.x | 140 | 22.18 | 2025 Q3 | 已停止支持 |
| 39.x | 142 | 22.20 | 2025-10 | 已停止支持 |
| 40.x | 144 | 24.11 | 2026-01 | 已停止支持 |
| 41.x | 146 | 24.14 | 2026-03 | 已停止支持（2026-08-25 EOL） |
| 42.x | 148 | 24.15 | 2026-05 | ✅ 受支持 |
| 43.x | 150 | 24.17 | 2026-06 | ✅ 受支持 |
| 44.x | 152 | 24.18 | 2026-08 | ✅ 当前稳定版（不再支持 macOS 12 与 32 位平台） |

> 版本策略：Electron 与 Chrome 同步，约每 8 周发布一个新主版本，**同时只支持最近三个主版本**（当前为 42/43/44）。选择 Electron 版本时，关注其捆绑的 Chromium 版本——这决定了你能用哪些 Web API（如 CSS 特性、Web API 等）。版本与 EOL 时间可查官方发布日历：releases.electronjs.org。
