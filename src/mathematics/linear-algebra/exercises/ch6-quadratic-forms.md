...
**S1（解答）**：求参数 $t$ 的取值范围，使 $f(x_1, x_2, x_3) = x_1^2 + 4x_2^2 + 4x_3^2 + 2tx_1x_2$ 为正定二次型。
...
- B： $A = \begin{pmatrix} 2 & 0 & 0 \\ 0 & 3 & 2 \\ 0 & 2 & 3 \end{pmatrix}$ ， $\Delta_1 = 2$ ， $\Delta_2 = 5$ ， $\Delta_3 = 10$ 全正，**正定** ✓；
...
- A： $p = 2, q = 1$ ✗；B： $\mathrm{diag}(2, 4, 6)$ 的 $p = 3, q = 0$ ✓ （取 $C = \mathrm{diag}\left(1, \sqrt{2}, \sqrt{2}\right)$ 即得）；C： $p = 0$ ✗；D： $p = 2, q = 0$ ✗。
