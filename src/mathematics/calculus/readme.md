...
> 面向 **考研数学二** 的高等数学学习路径。数二高等数学约占 78%（约 117 分），是复习的绝对主体。
...
| 项目 | 说明 |
|------|------|
| **考试定位** | 考研数学二，高等数学约占 78%（约 117 分） |
| **分值分布** | 选择题约 40 分 + 填空题约 20 分 + 解答题约 57 分 |
| **核心能力** | 计算能力（求极限、求积分、解微分方程）> 证明能力 |
| **学习周期** | 约 8-10 周（基础阶段） |
| **教材推荐** | 同济大学《高等数学》第七版 / 汤家凤《高等数学辅导讲义》 |
| **数二特有** | ⚠️ 不考曲线曲面积分、三重积分、无穷级数、概率统计 |
...
- [ ] 熟练掌握极限计算的 3 种方法（等价无穷小替换、洛必达、泰勒展开）
- [ ] 熟练掌握基本求导公式和求导法则（链式法则、隐函数）
- [ ] 能应用中值定理（罗尔、拉格朗日）做简单证明题
- [ ] 熟练掌握不定积分的换元法和分部积分法
- [ ] 能计算定积分并应用于面积、旋转体体积
- [ ] 能计算二重积分（直角坐标、极坐标、交换次序）
- [ ] 能解一阶线性微分方程和二阶常系数线性微分方程

---

## 🔗 关联模块

- [linear-algebra/](../linear-algebra/readme.md) — 线性代数
